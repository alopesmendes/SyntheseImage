...
extern double g2x_RandIntervall(double inf, double sup)
{
	if (sup<inf) { fprintf(stderr,"<g2x_RandIntervall> : intervalle invalide\n"); return 0.; }
	return g2x_RandDelta(0.5*(sup+inf),0.5*(sup-inf));
}

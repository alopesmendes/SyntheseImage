...
extern void g2x_FillRectangle_Tex(double xd, double yd, double xu, double yu, float* TEX, int nbl, int nbc)
{
  int texName;
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, nbc,nbl, 0, GL_RGB, GL_UNSIGNED_BYTE,TEX);

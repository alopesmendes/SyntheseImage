...
{ 
  ...
  g3x_SetScrollWidth(6);
	g3x_CreateScrollv_d("ray",&rayon,0.1,  2.0,1,"rayon sphere     ");
	g3x_CreateScrollv_d("ang",&angle,0.0,360.0,1,"angle rotation   ");
	g3x_CreateScrollv_d("alf",&alpha,0.0,  1.0,1,"transparence cube");

	g3x_SetScrollWidth(4);	
	g3x_CreateScrollh_d("shin",&shin,0.0,1.0,1,"intensite lumiere brillance ");
	g3x_CreateScrollh_d("spec",&spec,0.0,1.0,1,"intensite lumiere speculaire");
	g3x_CreateScrollh_d("diff",&diff,0.0,1.0,1,"intensite lumiere diffuse   ");
	g3x_CreateScrollh_d("ambi",&ambi,0.0,1.0,1,"intensite lumiere ambiante  ");
